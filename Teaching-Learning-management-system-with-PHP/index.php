		...
		<div class="container">
			...
			<section id="about" class="d-flex justify-content-center align-items-center flex-column">
				<div class="card mb-3 card-1">
					<div class="row g-0">
						<div class="col-md-4">
							<img src="imgs/logo1.png" alt="logo" class="img-fluid rounded-start">
						</div>
						<div class="col-md-8">
							<div class="card-body">
								<h5 class="card-title">Giới thiệu</h5>
								<p class="card-text">About BK</p>
								<p class="card-text"><small class="text-muted">HUST</small></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row g-0">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<p class="card-text"><span class="material-symbols-outlined">
										home
									</span>17 Tạ Quang Bửu, Hai Bà Trưng, Hà Nội</p>
								<p class="card-text"><small class="text-muted">HUST</small></p>
							</div>
						</div>
					</div>
